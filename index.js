...
var dict = {
  ...
  '01/03': "Fruitcake Toss Day",
  '01/04': "Trivia Day",
  '01/05': "National Bird Day",
  '01/06': "Bean Day",
  '01/07': "National Bobblehead Day",
  '01/08': "Elvis Presley's Birthday",
  '01/09': "Play God Day",
  '01/10': "Bittersweet Chocolate Day",
  '01/11': "Morse Code Day",
  '01/12': "National Hot Tea Day",
  '01/13': "International Skeptics Day",
  '01/14': "National Dress Up Your Pet Day",
  '01/15': "National Hat Day",
  '01/16': "National Nothing Day",
  '01/17': "National Bootlegger's Day",
  ...
  '01/24': "Compliment Day",
  '01/25': "Opposite Day",
  '01/26':"Plan for a Vacation Day",
  '01/27': "National Chocolate Cake Day",
  '01/28': "Fun at Work Day",
  ...
  bot.webex.memberships.list({roomId: bot.room.id})
    .then((memberships) => {
      for (const member of memberships.items) {
        ...
        bot.say(`Hello ${displayName}. Consider discussing with you friends about ` + dict[today]);
      }
    })
    .catch((e) => {
